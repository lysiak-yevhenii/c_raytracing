...
unsigned int		ft_dot_product(vector_3 v1, vector_3 v2) //scalar result
{
...
vector_3			*ft_multiply_scalar(vector_3 v1, int scalar)
{
	vector_3	result_vector;
...
vector_3			*ft_subtract_vectors(vector_3 v1, vecor_3 v2)
{
	vector_3	result_vector;
...
vector_3			ft_unit_vector(vector_3 v)
{
	...
	unit_vector.x = (v.x / (sqrt(pow(v.x) + pow(v.y) + pow(v.z))));
	unit_vector.y = (v.y / (sqrt(pow(v.x) + pow(v.y) + pow(v.z))));
	unit_vector.z = (v.z / (sqrt(pow(v.x) + pow(v.y) + pow(v.z))));	
	return (unit_vector);
}
